...
- (void)applyConfigurationTemplate {
    ...
    QMUICMI.blackColor = UIColorMake(90, 90, 90);                                  // UIColorBlack : 黑色（不用 [UIColor blackColor] 是希望保持颜色空间为 RGB）
    ...
    QMUICMI.backgroundColor = [UIColor groupTableViewBackgroundColor];                                              // UIColorForBackground : 界面背景色，默认用于 QMUICommonViewController.view 的背景色
    ...
    QMUICMI.tableViewBackgroundColor = UIColorMakeWithHex(@"#F6F5F8");                                     // TableViewBackgroundColor : Plain 类型的 QMUITableView 的背景色颜色
