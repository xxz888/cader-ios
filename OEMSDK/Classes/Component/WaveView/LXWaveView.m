...
//            self.layer.masksToBounds = NO;
    ...
    self.waveNum = 3;
    self.amplitude = 10;
    self.angularSpeed = M_PI *2 / self.frame.size.width ;
    self.offsetK = 10;
    ...
    for (int i = 0; i < _waveNum; i ++) {
        ...
        LXWaveModel *waveModel = [[LXWaveModel alloc] init];
...
- (void)drawWaveAnimation {
    for (LXWaveModel *waveModel  in self.waveModels) {
...
//    //绘制动画
    ...
    [layer addAnimation:waveAnimation forKey:@"waveAnimation"];
}

@end

#pragma mark - 波浪模型
@implementation LXWaveModel
