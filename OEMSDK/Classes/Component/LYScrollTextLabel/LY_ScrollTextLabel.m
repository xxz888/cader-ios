//
//  LY_ScrollTextLabel.m
//  Project
//
//  Created by 熊凤伟 on 2018/1/9.
...
@implementation LY_ScrollTextLabel
...
- (void)commonInit {
    ...
    // default values
    _scrollDirection = LYAutoScrollDirectionLeft;
...
- (void)setScrollDirection:(LYAutoScrollDirection)direction {
...
- (void)scrollLabelIfNeeded {
    ...
    BOOL doScrollLeft = (self.scrollDirection == LYAutoScrollDirectionLeft);
...
- (void)applyGradientMaskForFadeLength:(CGFloat)fadeLength enableFade:(BOOL)fade {
    ...
    if (fadeLength) {
        ...
        if (!fade) switch (self.scrollDirection) {
            case LYAutoScrollDirectionLeft:
                leftFadePoint = @0;
                break;
                
            case LYAutoScrollDirectionRight:
                leftFadePoint = @0;
                rightFadePoint = @1;
                break;
        }
