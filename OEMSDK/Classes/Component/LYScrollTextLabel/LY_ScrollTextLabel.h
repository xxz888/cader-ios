...
typedef NS_ENUM(NSInteger, LYAutoScrollDirection) {
    LYAutoScrollDirectionRight,
    LYAutoScrollDirectionLeft
};

@interface LY_ScrollTextLabel : UIView <UIScrollViewDelegate>

@property (nonatomic) LYAutoScrollDirection scrollDirection;
