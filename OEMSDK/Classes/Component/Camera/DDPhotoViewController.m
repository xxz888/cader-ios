...
-(UIView *)topView{
    if (!_topView ) {
        _topView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, ScreenWidth, 105)];
...
-(UIButton *)cancleButton{
    if (_cancleButton == nil) {
        ...
        _cancleButton.frame = CGRectMake(ScreenWidth-40, LY_iPhoneX ? 0 : kStatusBarHeight + 15, 30, 30);
        [_cancleButton setImage:[UIImage mc_imageNamed:@"cancelPhoto"] forState:(UIControlStateNormal)];
...
-(UIButton *)reCamButton{
    if (_reCamButton == nil) {
        ...
        [_reCamButton setLineBreakMode:NSLineBreakByWordWrapping];
...
-(UIButton *)PhotoButton{
    if (_PhotoButton == nil) {
        ...
        [_PhotoButton setImage:[UIImage mc_imageNamed:@"photograph"] forState: UIControlStateNormal];
        [_PhotoButton setImage:[UIImage mc_imageNamed:@"photograph_Select"] forState:UIControlStateNormal];
...
-(UIButton *)selectButton{
    if (_selectButton == nil) {
        ...
        [_selectButton setLineBreakMode:NSLineBreakByWordWrapping];
...
-(UIImageView *)focusView{
    if (_focusView == nil) {
        ...
        _focusView.image = [UIImage mc_imageNamed:@"foucs80pt"];
...
- (UIImageView *)kuangImgView {
    if (_kuangImgView == nil) {
        ...
        _kuangImgView.image = [UIImage mc_imageNamed:@"photoKuang"];
    }
