//
//  KDShiftToProvisionsViewController.m
//  KaDeShiJie
//
...
@interface KDShiftToProvisionsViewController ()
...
@implementation KDShiftToProvisionsViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    
    self.view.backgroundColor = [UIColor qmui_colorWithHexString:@"#F5F5F5"];
    [self setNavigationBarTitle:@"转入备付金" tintColor:nil];
